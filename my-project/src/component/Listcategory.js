...
const Icon = ({ nama }) => {
  ...
  if (nama === "Semua") return <FontAwesomeIcon icon={faList} className="mr-2" />;
  ...
  componentDidMount() {
    axios
      ...
      .then((res) => {
        ...
        // ✅ Tambahkan kategori "Semua" di paling awal
        const categoriesWithAll = [{ id: 0, nama: "Semua" }, ...categories];
